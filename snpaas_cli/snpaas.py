...
def docker_check():
    ...
    try:
        ...
        if e.errno == os.errno.ENOENT:
            ...
            print("Please install docker client in your system!", file=sys.stderr)
            print("Documentation: %s" % __url__, file=sys.stderr)
        else:
            # Something else went wrong while trying to run `wget`
            raise
    except subprocess.CalledProcessError as e:
        print(str(e), file=sys.stderr)
        print("Please check your docker environment!", file=sys.stderr)
...
def main():
    ...
    parser.add_argument('--quiet', help='Suppress info motd using regex defined by SNPAAS_SUPPRESS_INFO_REGEX', default=False, action='store_true')
